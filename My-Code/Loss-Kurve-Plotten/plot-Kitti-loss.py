...
def main():
    ...
    ap.add_argument(
        "csv_path",
        nargs="?",
        default="/mnt/data1/Hussein-thesis-repo/Checkpointss/Checkpoint-mit-Carla-Masks/loss_history.csv",
        help="Pfad zur loss_history.csv"
    )
    ap.add_argument("--title", default="KITTI training loss", help="Plot Titel")
